public class Motorrad extends Fahrzeug {
    ...
    public Motorrad(String marke, String farbe, int sitzplätze, int räder, int ps, boolean status,
    ...
    public String toString() {
        return "Motorrad: " + "Marke: "+ super.getMarke()+"Farbe: "+super.getFarbe() +"Jahr: "+super.getJaht()
